  ...
  <div>
   ...
   >
    ...
    >
     ...
     приоритетности следует считать создание таких условий, чтобы устранение неисправности прошло не
     только в предельно сжатые сроки, но и в максимально безопасном режиме.
    </Typography>
    <br />
    <br />
   </p>
