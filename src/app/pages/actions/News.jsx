   ...
   <div className='block1'>
    ...
    <p>
     ...
     <Typography variant='caption'>
      ...
      началом проведения работ проходит инструктаж по технике безопасности (ответственный за его
      проведение – начальник электротехнической службы хозяйства). К устранению неисправностей
      привлеченные исполнители приступают лишь при наличии у них специальных защитных cредств для
      работы с установками под напряжением до 1000 В – речь ведется о диэлектрических перчатках,
      инструментарии с диэлектрическими ручками, переносном заземлении (закоротке). К числу
      дополнительных защитных средств относят изолирующие подставки, галоши, материал изготовления
      которых обладает диэлектрическими характеристиками.
     </Typography>
    </p>
    <br />
    <br />
