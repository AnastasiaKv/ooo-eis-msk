   ...
   <div className='block1'>
    ...
    <p style={{paddingTop: '43px'}}>
     <Typography variant='subtitle2' component='span' style={bodyStyle}>
      ...
      включать. Работают люди". Отвечающим за ремонт электрических установок специалистам необходимо
      принять меры для предупреждения вращения электрического двигателя от машины.
     </Typography>
    </p>
   </div>
   <br />
